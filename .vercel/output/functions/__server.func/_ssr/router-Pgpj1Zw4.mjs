...
import { a as RotateCcw, b as BookMarked, f as Languages, h as ClipboardList, p as House, r as TriangleAlert } from "../_libs/lucide-react.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-Pgpj1Zw4.js
...
function AppShell({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: NAV.map((item) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: item.to,
								className: cn("inline-flex h-10 items-center gap-2 rounded-md px-2.5 text-sm transition-colors duration-150 lg:px-3", active ? "bg-primary-soft text-primary" : "text-muted hover:bg-bg-deep hover:text-ink"),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				className: "fixed inset-x-0 bottom-0 z-20 border-t border-border bg-surface/95 px-1 py-2 backdrop-blur-md sm:hidden",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mx-auto grid max-w-md grid-cols-5 gap-0.5",
					children: NAV.map((item) => {
						const active = item.match === "home" ? pathname === "/" || isLesson : pathname.startsWith(item.to);
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: item.to,
							className: cn("flex h-12 flex-col items-center justify-center gap-0.5 rounded-md text-[11px]", active ? "bg-primary-soft text-primary" : "text-muted"),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(item.icon, { className: "size-4" }), item.label]
						}, item.to);
					})
				})
...
var styles_default = "/assets/styles-DAviC4U6.css";
var APP_NAME = "みんな教室";
...
var $$splitComponentImporter$9 = () => import("./routes-ZcveXX44.mjs");
var Route$9 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./exam-B5owb8VD.mjs");
var Route$8 = createFileRoute("/exam")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./n4-D3P_Cgjy.mjs");
var Route$7 = createFileRoute("/n4")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./ref-BF0RcofK.mjs");
var Route$6 = createFileRoute("/ref")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./review-DI8LnyvB.mjs");
var Route$5 = createFileRoute("/review")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./start-DO3FpXuA.mjs");
var Route$4 = createFileRoute("/start")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./exam.index-CSN_IMZ3.mjs");
...
var $$splitComponentImporter$2 = () => import("./exam._id-C2QneGa_.mjs");
...
var $$splitComponentImporter$1 = () => import("./lesson._id-DM9BszLw.mjs");
...
var $$splitComponentImporter = () => import("./unit._id-ThfkChac.mjs");
...
var ExamRoute = Route$8.update({
	id: "/exam",
	path: "/exam",
	getParentRoute: () => Route$10
});
var N4Route = Route$7.update({
	id: "/n4",
	path: "/n4",
	getParentRoute: () => Route$10
});
var RefRoute = Route$6.update({
	id: "/ref",
	path: "/ref",
	getParentRoute: () => Route$10
});
