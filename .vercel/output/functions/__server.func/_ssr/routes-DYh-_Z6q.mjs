...
import { c as LESSON_UNITS, o as PageTitle } from "./router-B2yMlw1C.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DYh-_Z6q.js
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-1 text-sm text-muted",
						children: [MOCK_EXAMS.length, " 回 · 含 N4 真題形式 85 題"]
					})
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "grid size-11 shrink-0 place-items-center rounded-full bg-primary-soft text-primary",
