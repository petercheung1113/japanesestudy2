...
import { S as ArrowLeft, m as Headphones, n as Volume2, t as X, v as Check } from "../_libs/lucide-react.mjs";
import { a as Route$2, l as cn } from "./router-B2yMlw1C.mjs";
import { n as getExam } from "./exams-BmRRtGlj.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/exam._id-CFoedE2h.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var DEFAULT_PART_HINT = {
...
function groupQuestions(questions) {
	...
	questions.forEach((q, index) => {
		...
		if (lastBlock && (lastBlock.passage ?? "") === (q.passage ?? "")) lastBlock.items.push({
			q,
			index
		});
		else last.blocks.push({
			passage: q.passage,
			items: [{
				q,
				index
...
function playExamAudio(audio) {
	const parts = audio.split(/(?=男：|女：|店員：|社員：|先生：|学生：)/).map((s) => s.trim()).filter(Boolean);
	if (parts.length > 1) speakSequence(parts, .86, 480);
	else speakJapanese(audio, .86);
}
function ExamPage() {
	...
	const groups = (0, import_react.useMemo)(() => section ? groupQuestions(section.questions) : [], [section]);
	...
	if (phase === "intro") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: official ? "真題形式 85題・110分" : "練習短縮"
			})]
		}),
		...
		official ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mt-4 rounded-xl border border-border bg-surface px-4 py-3 text-sm leading-relaxed text-muted",
			children: "對齊正式 N4：言語知識（文字・語彙）28 題、文法 21 題、読解 8 題（75 分），聴解 28 題（35 分）。題目為原創，沒有抄錄真題。聴解問題 3・4 只有三個選項。"
		}) : null,
	...
	if (phase === "result") {
		const reviewGroups = groupQuestions(reviewWrong ? allQuestions.filter((q) => answers[q.id] !== q.answer) : allQuestions);
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: reviewGroups.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mb-3 text-xs tracking-wide text-primary",
				children: g.part
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				className: "space-y-4",
				children: g.blocks.flatMap((b) => b.items.map(({ q, index }) => {
							...
							children: [ok ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "mt-0.5 size-4 shrink-0 text-success" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "mt-0.5 size-4 shrink-0 text-danger" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									q.promptJp ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-1 font-display text-base text-primary",
										children: q.promptJp
									}) : null,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: g.part
					}), g.instruction ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 border-t border-border pt-2 text-sm leading-relaxed text-muted",
						children: g.instruction
					}) : null]
				}), g.blocks.map((b, bi) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-3",
					children: [b.passage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "whitespace-pre-wrap rounded-xl border border-border bg-bg-deep/70 px-4 py-3 font-display text-base leading-relaxed text-ink",
						children: b.passage
					}) : null, b.items.map(({ q, index }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QuestionCard, {
						number: index + 1,
						question: q,
						hidePassage: true,
						value: answers[q.id],
...
function QuestionCard({ number, question, value, fill, plays, hidePassage, onFill, onChoose, onPlay }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			!hidePassage && question.passage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			question.type === "fill" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: question.options.map((option, i) => {
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "mr-2 inline-block min-w-4 tabular-nums text-subtle",
							children: i + 1
						}), option]
					}, option);
				})
