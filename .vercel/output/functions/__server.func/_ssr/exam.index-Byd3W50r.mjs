...
import { o as PageTitle } from "./router-B2yMlw1C.mjs";
import { t as MOCK_EXAMS } from "./exams-BmRRtGlj.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/exam.index-Byd3W50r.js
...
function ExamIndex() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mb-6 rounded-xl border border-primary/25 bg-primary-soft px-4 py-3 text-sm leading-relaxed text-ink",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "font-medium text-primary",
				children: "N4 第 4 回＝真題形式"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-muted",
				children: "正式 N4 是 85 題、110 分：言語知識（文字・語彙）28、文法 21、読解 8（合計 75 分），聴解 28（35 分）。問題種類含読み・表記・文脈・言い換え・用法、文の文法・並べ替え・文章の文法、短文・中文・情報検索，以及聴解的課題・ポイント・発話表現・即時応答。第 1–3 回是短縮練習。"
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										className: official ? "rounded-full bg-primary px-2 py-0.5 text-xs text-primary-fg" : "rounded-full bg-bg-deep px-2 py-0.5 text-xs text-subtle",
										children: official ? "真題形式" : "練習短縮"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
